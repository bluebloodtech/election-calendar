  ...
  return (
    ...
    <main className="apple-calendar flex min-h-screen flex-col items-center px-4 py-10 sm:px-8">
      <div className="mb-8 w-full max-w-5xl">
        <Link
          href="/"
          className="focus-ring font-display text-xs uppercase tracking-widest text-text-muted hover:text-gold"
        >
          ‹ Back to Master
        </Link>
        <p className="mt-3 font-display text-xs uppercase tracking-[0.3em] text-gold">
          Election Nightclub
        </p>
